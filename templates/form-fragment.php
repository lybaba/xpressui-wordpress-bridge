...
#<?php echo esc_attr($xpressui_mount_id); ?>[data-resume-loading] [data-resume-loader] { display: grid !important; }
...
#<?php echo esc_attr($xpressui_mount_id); ?> .xpressui-resume-loader { min-height: 320px; display: none; place-items: center; padding: 28px 0; }
#<?php echo esc_attr($xpressui_mount_id); ?> .xpressui-resume-loader-card { width: min(100%, 420px); display: grid; justify-items: center; gap: 12px; padding: 28px 24px; border-radius: 24px; border: 1px solid rgba(37, 99, 235, 0.12); background: rgba(255, 255, 255, 0.94); box-shadow: 0 24px 60px -36px rgba(15, 23, 42, 0.28); text-align: center; }
#<?php echo esc_attr($xpressui_mount_id); ?> .xpressui-resume-loader-spinner { width: 42px; height: 42px; border-radius: 999px; border: 3px solid rgba(37, 99, 235, 0.16); border-top-color: #2563eb; animation: xpressui-spin 0.72s linear infinite; }
#<?php echo esc_attr($xpressui_mount_id); ?> .xpressui-resume-loader-title { font-size: 18px; font-weight: 700; letter-spacing: -0.02em; color: #0f172a; }
#<?php echo esc_attr($xpressui_mount_id); ?> .xpressui-resume-loader-text { margin: 0; max-width: 32ch; font-size: 13px; line-height: 1.6; color: #64748b; }
