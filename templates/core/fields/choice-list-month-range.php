...
?>
<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_and_value(xpressui_bridge_template_and_value((!xpressui_bridge_template_truthy(($__xpns_active_year['value'] ?? null))), xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'default_selected')), xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year')))): ?>
<?php $__xpns_active_year['value'] = xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year'); ?>
<?php endif; ?>
<?php endforeach; $xpressui_ctx = $xpressui_loop_parent_ctx_2; ?>
<?php if (xpressui_bridge_template_truthy((!xpressui_bridge_template_truthy(($__xpns_active_year['value'] ?? null))))): ?>
<?php
...
?>
<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_and_value((!xpressui_bridge_template_truthy(($__xpns_active_year['value'] ?? null))), xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year')))): ?>
<?php $__xpns_active_year['value'] = xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year'); ?>
<?php endif; ?>
<?php endforeach; $xpressui_ctx = $xpressui_loop_parent_ctx_10; ?>
<?php endif; ?>
<?php $__xpns_year_group = ['key' => "", 'open' => false]; ?>
<?php
...
?>
<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_and_value(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year'), (!xpressui_bridge_template_equals(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year'), ($__xpns_year_group['key'] ?? null)))))): ?>
<?php if (xpressui_bridge_template_truthy(($__xpns_year_group['open'] ?? null))): ?>
            </div>
          </section>
<?php endif; ?>
<?php $__xpns_year_group['key'] = xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year'); ?>
<?php $__xpns_year_group['open'] = true; ?>
        <section class="template-month-range-year" data-choice-year-group="<?php echo esc_attr(xpressui_bridge_template_stringify(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year'))); ?>" data-active="<?php echo esc_attr(xpressui_bridge_template_stringify((xpressui_bridge_template_truthy(xpressui_bridge_template_equals(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year'), ($__xpns_active_year['value'] ?? null))) ? "true" : "false"))); ?>"<?php if (xpressui_bridge_template_truthy((!xpressui_bridge_template_equals(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'choice'), 'year'), ($__xpns_active_year['value'] ?? null))))): ?> hidden<?php endif; ?>>
...
?>
<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_and_value(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'year_choice'), 'year'), (!xpressui_bridge_template_contains(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'year_choice'), 'year'), ($__xpns_seen_years['values'] ?? null)))))): ?>
<?php $__xpns_seen_years['values'] = xpressui_bridge_template_add(($__xpns_seen_years['values'] ?? null), [xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'year_choice'), 'year')]); ?>
                    <option value="<?php echo esc_attr(xpressui_bridge_template_stringify(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'year_choice'), 'year'))); ?>"<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_equals(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'year_choice'), 'year'), ($__xpns_active_year['value'] ?? null)))): ?> selected<?php endif; ?>><?php echo esc_attr(xpressui_bridge_template_stringify(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'year_choice'), 'year'))); ?></option>
<?php endif; ?>
