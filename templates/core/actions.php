...
<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'runtime'), 'booking_url'))): ?>
  <a class="xpressui-booking-btn" href="<?php echo esc_attr(xpressui_bridge_template_stringify(esc_url(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'runtime'), 'booking_url')))); ?>"><?php $xpressui_booking_label = xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'runtime'), 'booking_button_label'); echo esc_attr(xpressui_bridge_template_stringify($xpressui_booking_label !== '' ? $xpressui_booking_label : xpressui_bridge_template_wp_text("Book an appointment", 'xpressui-bridge'))); ?></a>
<?php endif; ?>
</div>
