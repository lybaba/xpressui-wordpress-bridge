...
backdrop-filter: blur(18px) saturate(1.08);<?php endif; ?>
    ...
    .xpressui-booking-btn { display: none; margin-top: 6px; padding: 8px 18px; background: var(--template-primary); color: #fff; text-decoration: none; border-radius: var(--template-button-radius); font-size: 13px; font-weight: 600; justify-self: start; }
