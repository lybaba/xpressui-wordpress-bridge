...
<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'runtime'), 'submit_enctype'))): ?>enctype="<?php echo esc_attr(xpressui_bridge_template_stringify(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'runtime'), 'submit_enctype'))); ?>"<?php endif; ?>>
...
<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'rendered_form'), 'show_title'))): ?>    <h1 class="template-form-title"><?php echo esc_attr(xpressui_bridge_template_stringify(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'rendered_form'), 'title'))); ?></h1>
<?php endif; ?><?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_and_value(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'rendered_form'), 'show_subtitle'), xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'rendered_form'), 'subtitle')))): ?>      <p class="template-form-subtitle"><?php echo esc_attr(xpressui_bridge_template_stringify(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'rendered_form'), 'subtitle'))); ?></p>
<?php endif; ?>  </header>

<?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_attr(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'rendered_form'), 'step_status'), 'enabled'))): ?>    <section
...
<?php endif; ?><?php if (xpressui_bridge_template_truthy(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'rendered_form'), 'has_sections'))): ?><?php $xpressui_loop_parent_ctx_2 = $xpressui_ctx; $xpressui_loop_items_1 = xpressui_bridge_template_iterable(xpressui_bridge_template_attr(xpressui_bridge_template_context_get($xpressui_ctx, 'rendered_form'), 'sections')); foreach ($xpressui_loop_items_1 as $xpressui_loop_index_3 => $xpressui_loop_value_4): $xpressui_ctx = $xpressui_loop_parent_ctx_2; $xpressui_ctx['section'] = $xpressui_loop_value_4; $xpressui_ctx['loop'] = ['index' => $xpressui_loop_index_3 + 1, 'index0' => $xpressui_loop_index_3, 'first' => $xpressui_loop_index_3 === 0, 'last' => ($xpressui_loop_index_3 + 1) === count($xpressui_loop_items_1)]; ?><?php xpressui_bridge_template_include_template('section.php', $xpressui_ctx); ?><?php endforeach; $xpressui_ctx = $xpressui_loop_parent_ctx_2; ?><?php else: ?>    <section class="template-section" data-template-zone="empty_form">
...
<?php endif; ?><?php xpressui_bridge_template_include_template('actions.php', $xpressui_ctx); ?></form>
