...
<?php else: ?>        <?php echo esc_attr(xpressui_bridge_template_stringify(xpressui_bridge_template_wp_text("Open the device camera or choose an existing photo from your gallery.", 'xpressui-bridge'))); ?>
<?php endif; ?>    </div>
