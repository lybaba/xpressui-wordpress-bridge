...
<?php xui_jinja_include('head.php', $__ctx); ?><?php if (xui_jinja_truthy(xui_jinja_eq(xui_jinja_context_get($__ctx, 'target'), "wordpress"))): ?><style>
  ...
  * { box-sizing: border-box !important; }
  .page-shell { background: transparent !important; padding: 2px !important; min-height: 0 !important; height: auto !important; overflow: hidden !important; align-items: flex-start !important; width: 100% !important; }
