...
function xpressui_handle_submission(WP_REST_Request $request) {
    ...
    $project_id = $request->get_param('projectId') ?: '25k54TASknzR2bCmW6sT3V';
    $project_config_version = $request->get_param('projectConfigVersion') ?: '';
    $submission_id = $request->get_param('submissionId');
    $project_slug = $request->get_param('projectSlug') ?: 'hello-world';
    ...
    xpressui_set_submission_status($post_id, 'new', "Your submission was sent successfully.");
    ...
    return new WP_REST_Response(['success' => true, 'message' => "Your submission was sent successfully.", 'entryId' => $post_id, 'submissionId' => $submission_id, 'files' => $stored_files], 200);
}
...
// Suggested shortcode function: xpressui_render_hello_world