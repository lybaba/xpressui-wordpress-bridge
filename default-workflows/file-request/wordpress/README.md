...
```text
   ...
   [xpressui id="file-request" redirect="https://yoursite.com/thank-you/"]
```
...
- workflow package path: `/wp-content/uploads/xpressui/file-request/`
- plugin shell URL: `/?xpressui_shell=file-request`
